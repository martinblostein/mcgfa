...
double (*testfunc)(double*,double*,double*,int,int*,int,int,int,int,double*,
        double*,double*,double*,double*,int,int,double,double,double,int,int*);
...
void mcgfa_c(double *x, double *z, double *v, double *bic, int *cls, int *q, int *p, int *G, int *N,
              double *mu, int *model, int *fixed_alpha, int *fixed_eta, int *class_ind, double *lambda,
              double *psi, double *eta, double *alpha, double *eta_max, double *alpha_min,
              double *tol, int *max_it, int *iterations) {

    funcType aecm_func = funcs[*model-1];
    *bic = aecm_func(z, x, v, *class_ind, cls, *q, *p, *G, *N, mu, lambda,
                     psi, eta, alpha, *fixed_alpha, *fixed_eta, *eta_max, *alpha_min, *tol, *max_it, iterations);
}
